...
- description: Mathematical framing, empirical risk minimization, and loss surfaces.
  ...
  - discriminant: lesson
    value:
      lessonRef: ml-supervised-unsupervised-intro
  - discriminant: lesson
    value:
      lessonRef: ml-gradient-descent-mechanics
  - discriminant: lesson
    value:
      lessonRef: ml-interactive-lab
  title: The Machine Learning Paradigm
- description: Ordinary least squares, normal equations, and regression metrics.
  items:
  - discriminant: lesson
    value:
      lessonRef: ml-linear-regression-from-scratch
  - discriminant: quiz
    value:
      quizRef: ml-regression-metrics-quiz
  title: Regression & Analytical Solutions
- description: Controlling variance with Ridge, Lasso, and k-fold cross-validation.
  items:
  - discriminant: lesson
    value:
      lessonRef: ml-regularization-bias-variance
  - discriminant: assignment
    value:
      assignmentRef: ml-housing-price-predictor
