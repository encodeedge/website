      ...
      {mounted &&
        createPortal(
          <>
            ...
            <div
              className={cn(
                "fixed top-0 left-0 h-full w-[85%] max-w-[360px] bg-background border-r border-border shadow-2xl z-[10000] transform transition-transform duration-300 ease-in-out xl:hidden flex flex-col justify-between p-6",
